...
var fs   = require('fs');
var resolvers = {'../resolvers/path.js': require('../resolvers/path.js'),'../resolvers/reduce-postfix.js': require('../resolvers/reduce-postfix.js'),'../resolvers/reduce-prefix.js': require('../resolvers/reduce-prefix.js'),'../resolvers/reduce.js': require('../resolvers/reduce.js')};
...
module.exports = require('browserify-transform-tools').makeRequireTransform(
  ...
  function (args, opts, done) {
    ...
    // set default key option to "path"
    config.key = config.key || "path";
